...
function mineacle_stats_hearts_html(mixed $hearts, string $className = 'fight-hearts'): string
{
    ...
    $fullHeart = '/shared/assets/images/stats/full-heart.png' . $assetQuery;
    $partialHeart = '/shared/assets/images/stats/partial-heart.png' . $assetQuery;
    $emptyHeart = '/shared/assets/images/stats/empty-heart.png' . $assetQuery;
