...
return [
    'site' => [
        ...
        'support_email' => $mineacleEnv(['SUPPORT_EMAIL', 'support_email']),
    ...
    'contact' => [
        'recipient' => $mineacleEnv(['BUG_REPORT_EMAIL', 'bug_report_email']),
        'from_email' => $mineacleEnv(['CONTACT_FROM_EMAIL', 'contact_from_email']),
    ],
];
