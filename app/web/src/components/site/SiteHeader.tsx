 ...
 * account pages. Render it as the first thing inside the hero box
 * (site/SiteFrame.module.css: .page > .heroFrame). Styles are in
 * SiteHeader.module.css and BlockButton.module.css.
 */
