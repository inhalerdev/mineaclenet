...
if (preg_match('#/(?:admin\.php|admin/index\.php)$#', $adminPath) === 1) {
...
function mineacle_admin_uploaded_image_url(): string
{
    ...
    $relativeDir = 'storage/uploads/announcements';
...
$adminStylesheetVersion = (string) (filemtime(__DIR__ . '/assets/css/admin.css') ?: mineacle_page_asset_version());
$adminScriptVersion = (string) (filemtime(__DIR__ . '/assets/js/admin.js') ?: mineacle_page_asset_version());

mineacle_page_head('Admin', [
    'stylesheets' => ['/admin/assets/css/admin.css?rev=' . rawurlencode($adminStylesheetVersion)],
    ...
    <?php else: ?>
        ...
        <section class="admin-grid">
            <form id="announcement-editor" class="admin-panel admin-form" method="post" action="/admin#announcement-editor" enctype="multipart/form-data">
                ...
                <label>
                    <span>Image URL</span>
                    <input name="image_url" type="text" maxlength="512" placeholder="https://... or /storage/uploads/..." value="<?php echo h($editImageUrl); ?>">
                </label>
                <?php if ($editImageUrl !== ''): ?>
...
<?php mineacle_page_end(['scripts' => ['/admin/assets/js/admin.js?rev=' . rawurlencode($adminScriptVersion)]]); ?>
