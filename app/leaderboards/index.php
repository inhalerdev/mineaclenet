...
{
    $icons = [
        'players' => '/player/assets/icons/top-player.png',
        'teams' => '/player/assets/icons/team.png',
    ];
    $file = $icons[$category] ?? '/player/assets/icons/top-player.png';
...
<?php mineacle_page_end(['scripts' => ['/shared/assets/js/site.js', '/leaderboards/assets/js/leaderboards.js']]); ?>
